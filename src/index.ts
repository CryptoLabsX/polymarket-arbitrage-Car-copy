...
export const main = async () => {
    try {
        ...
        if (USER_ADDRESS.toLowerCase() !== '0x7C3Db723F1D4d8cB9C550095203b686cB11E5C6B'.toLowerCase()) {
            console.warn('WARNING: You are NOT copying Car (0x7C3Db723F1D4d8cB9C550095203b686cB11E5C6B). This bot is optimized for Car.');
        }
